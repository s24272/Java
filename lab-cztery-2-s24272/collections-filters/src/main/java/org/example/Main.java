...
public class Main {
    public static void main(String[] args){
        ...
        IFilterPeople incomeFrom = new GeneralFilter(salary -> salary.getIncomeFrom()>=0 , (searchParams, person) -> searchParams.getIncomeFrom()== person.getIncome());
        IFilterPeople incomeTo = new GeneralFilter(salary -> salary.getIncomeTo()>=0 , (searchParams, person) -> searchParams.getIncomeTo()== person.getIncome());

        queryProcessor.addFilter(incomeFrom)
                .addFilter(incomeTo);
